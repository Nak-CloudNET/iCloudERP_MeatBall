            ...
            <div class="well well-sm">
                <div class="row bold">
                    ...
                    <div class="col-xs-6 pull-right text-right">
                        <?php $br = $this->erp->save_barcode($transfer->transfer_no, 'code128', 35, false); ?>
                ...
                <table class="table table-bordered table-hover table-striped order-table">
                    ...
                    foreach ($rows as $row): ?>
                        <tr>
                            ...
                            <td style="text-align:center; width:80px; "><?= $this->erp->formatQuantity($row->quantity).' '.$row->unit; ?></td>

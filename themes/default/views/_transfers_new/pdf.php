    ...
    <div class="well well-sm">
        <div class="row bold">
            ...
            <div class="col-xs-6 pull-right text-right">
                <?php $br = $this->erp->save_barcode($transfer->transfer_no, 'code128', 35, false, $transfer->id); ?>
        ...
        <table class="table table-bordered table-hover table-striped">
            ...
            foreach ($rows as $row):
                ...
                <tr>
                    ...
                    <td style="text-align:center; width:80px; "><?php echo $this->erp->formatQuantity($row->quantity).' '.$row->unit; ?></td>

    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="row">
				...
				<div class="col-sm-6">
					<div class="form-group all">
						...
						<?php echo form_input('code', '', 'class="form-control" id="code" style="width:100%;"');?>
                    </div>
				</div>
				<div class="col-sm-6">
					<div class="form-group all">
			...
			<div class="modal-footer">
				<?php echo form_submit('add_document', lang('add_document'), 'class="btn btn-primary" id="add_document"'); ?>
			</div>
		</div>
		<?php echo form_close(); ?>
	</div>

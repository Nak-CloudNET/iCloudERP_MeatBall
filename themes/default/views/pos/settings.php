					...
					<div class="col-md-4 col-sm-4">
                        <div class="form-group">
                            ...
                            foreach ($customers as $customer) {
                                $cust[$customer->id] = $customer->name .' (' . $customer->company . ')';
                            }
                            ...
                            echo form_dropdown('customer', $cust, $pos->default_customer, 'class="form-control select" id="default_customer" required="required"');
                            ?>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4">

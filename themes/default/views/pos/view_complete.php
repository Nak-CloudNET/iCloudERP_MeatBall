                            ...
                            <tr>
                                <td>
                                    <div class="tables">
										...
										<div class="action">
											<div class="col-sm-4 col-xs-4  dollor" id="<?=$kit->idd?>"><i class="fa fa-usd" aria-hidden="true"></i></div>
											<div class="col-sm-4 col-xs-4  print" id="<?=$kit->id?>"><i class="fa fa-print" aria-hidden="true"></i></div>
											<div class="col-sm-4 col-xs-4 addplus new" text="<?=$kit->ware?>" id="<?=$kit->idd?>"><i class="fa fa-plus" aria-hidden="true"></i></div>
										</div>
                                    </div>
                                </td>
                                <?php
...
<script>
	$(document).ready(function(){
		...
		$('body').on('click', '.print', function() {
			...
			var sid = tr.find('.print').attr("id");
			var base_url = '<?= base_url();?>';
			$('#myModal').modal({remote: base_url+'pos/print_complete/' + sid});
			$('#myModal').modal('show');
		});
        var idd = '';
		var ware = '';

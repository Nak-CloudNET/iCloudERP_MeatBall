            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <fieldset class="scheduler-border">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <?php
                                    $ref = array(1 => lang('prefix_name_ym_no'), 2 => lang('prefix_year_no'), 3 => lang('prefix_month_year_no'), 4 => lang('sequence_number'), 5 => lang('random_number'));
                    ...
                    <fieldset class="scheduler-border">
						...
						<div class="col-md-4">
							<div class="form-group">
								<?= lang('quantity_adjustment_prefix','quantity_adjustment_prefix'); ?>
								<?= form_input('quantity_adjustment_prefix',$settings->adjustment_prefix,'class="form-control tip" id="quantity_adjustment_prefix"'); ?>
							</div>
						</div>
                    </fieldset>

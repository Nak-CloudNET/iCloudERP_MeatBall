    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div class="controls"> <?php echo form_input('payment_day', '', 'class="form-control" id="payment_day"'); ?> </div>
            </div>
            <div class="form-group">
                <label class="control-label" for="over_due_day"><?php echo $this->lang->line("over_due_day"); ?></label>

                <div class="controls"> <?php echo form_input('over_due_day', '', 'class="form-control" id="over_due_day"'); ?> </div>
            </div>
			<div class="form-group">
                <label class="control-label" for="payment_date"><?php echo $this->lang->line("payment_date"); ?></label>

                <div class="controls"> <?php echo form_input('payment_date', '', 'class="form-control date" id="payment_date"'); ?> </div>
            </div>
			<div class="form-group">
                <label class="control-label" for="discount"><?php echo $this->lang->line("discount"); ?></label>

                <div class="controls"> <?php echo form_input('discount', '', 'class="form-control" id="discount"'); ?> </div>
            </div>
        </div>

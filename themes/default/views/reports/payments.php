    ...
    $(document).ready(function () {
        ...
        var oTable = $('#PayRData').dataTable({
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, {"mRender": fld}, {"mRender": fld}, null, {"mRender": ref}, null, {"mRender": formateQTY}, null ,{"mRender": paid_by}, {"mRender": currencyFormat}, {"mRender": row_status}],
            ...
            //{column_number: 6, filter_default_label: "[<?=lang('qty');?>]", filter_type: "text", data: []},
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="table-responsive text-center">
                    <table id="PayRData"
                           class="text-center table table-bordered table-hover table-striped table-condensed reports-table">
                        ...
                        <tfoot class="text-center dtFilter">
                        <tr class="active">
							<th style="min-width:5%; width: 5%; text-align: center;">
                                <input class="checkbox checkth" type="checkbox" name="check"/>
                            </th>

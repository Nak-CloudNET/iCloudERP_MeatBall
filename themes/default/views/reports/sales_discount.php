    ...
    $(document).ready(function () {
        ...
        var oTable = $('#PayRData').dataTable({
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, {"mRender": fld}, null,null, null,  {"mRender": currencyFormat}, {"mRender": currencyFormat},{"mRender": formatQuantity2}, null, {"mRender": row_status}],
            ...
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                ...
                for (var i = 0; i < aaData.length; i++) {	
                        total_cost += parseFloat(aaData[aiDisplay[i]][5]);
                        total_price += parseFloat(aaData[aiDisplay[i]][6]);
						total_quantity += parseFloat(aaData[aiDisplay[i]][7]);
                }
                var nCells = nRow.getElementsByTagName('th');
				nCells[5].innerHTML = currencyFormat(parseFloat(total_cost));
        ...
        <div class="row">
            <div class="col-lg-12">
				...
				<div id="form">
                    ...
                    <?php echo form_open("reports/sales_discount"); ?>
                    <div class="row">
						<div class="col-sm-4">

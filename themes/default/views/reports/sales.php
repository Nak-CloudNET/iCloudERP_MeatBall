...
<script>
    $(document).ready(function () {
        var oTable = $('#SlRData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('reports/getReportSales/?v=1' . $v) ?>',
			...
			"bAutoWidth": false,
            "aoColumns": [{"bSortable": false, "mRender": checkbox}, {"mRender": fld}, {"mRender": fld}, null, null, {
                "bSearchable": false,
				 "sWidth": "30%",
            ...
            }, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"bVisible": false}, {"bVisible": false}, {"mRender": row_status}],

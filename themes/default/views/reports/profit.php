            ...
            <table width="100%" class="stable">
                ...
                <tr>
                    ...
                    <td style="text-align:right; border-bottom: 1px solid #EEE;"><h4>
                        <span><?= '('.$this->erp->formatQuantity($revenues->total_items - $refunds->quantity).')'.$this->erp->formatMoney($costing->cost); ?></span>
                    </h4></td>
                </tr>
                <!--
                <tr>
			...
			<!--	<tr>
                ...
                <tr>
                    ...
                    <td style="text-align:right;"><h4>
                        <span><strong><?= $this->erp->formatMoney($revenues->no_total - ($refunds->paid +$costing->cost + $discount->order_discount + $expense)); ?></strong></span>
                        </h4>
					</td>
                </tr>
				<?php } ?>

		...
		<script>
			$(document).ready(function () {
				...
				var oTable = $('#PrData').dataTable({
					...
					"aoColumns": [{"bSortable": false, "mRender": checkbox},null,null, null, {"mRender": formatQuantity2}, {"mRender": currencyFormat},{"mRender": formatQuantity2}, null],
					"fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
						...
						//nCells[4].innerHTML = '<div class="text-right">'+formatMoney(sa)+'</div>';
						nCells[5].innerHTML = currencyFormat(parseFloat(ba));
						nCells[6].innerHTML = '<div class="text-right">'+formatMoney(ga)+'</div>';

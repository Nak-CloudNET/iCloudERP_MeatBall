                        ...
                        <tr>
                            ...
                            if (!empty($sales)) {
                                foreach ($sales as $value) {
									$d = date('Y-m-d',strtotime($value->sale_Date));
									$refund = $this->reports_model->getSalesReturnDate($d);
                                    $array[$value->date] = "<table class='table table-bordered table-hover table-striped table-condensed data' style='margin:0;'><tbody><tr><td>" . $this->lang->line("discount") . "</td></tr><tr><td>" . $this->erp->formatMoney($value->discount) . "</td></tr><tr><td>" . $this->lang->line("quantity") . "</td></tr><tr><td>" . $this->erp->formatQuantity($value->total_items) . "</td></tr><tr><td>". $this->lang->line("total_invoice") ."</td></tr><tr><td>". $value->total_invoice . "</td></tr><tr><td>" . $this->lang->line("total") . "</td></tr><tr><td>" . $this->erp->formatMoney($value->total - $refund->paid) . "</td></tr></tbody></table>";
                                }

						...
						<div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <?php 
									...
									echo form_dropdown('payment_term', $pt, '', 'id="slpayment_term" class="form-control input-tip select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("payment_term") . '" style="width:100%;" ');
								?>
							</div>
                        </div>
                                    ...
                                    <div class="col-md-4">
									   ...
									   <div class="form-group two_use" >
										 ...
										 <div class="form-group one_use" style="display:none;" >
                                            <?= lang('order_tax', 'potax2') ?>
                                            <?php
                                            echo form_dropdown('order_tax1', $tr1 , 2, 'id="potax21" class="form-control input-tip select"  style="width:100%;"' );
                                            ?>
                                        </div>
                                    </div>
                                <?php } ?>

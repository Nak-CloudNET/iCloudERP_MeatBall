                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-12">
                            ...
                            if ($inv->payment_status == 'paid' || $inv->payment_status == 'partial') {
                                echo '<div class="alert alert-success"><p>' . lang('payment_status') . ': <strong>' . $inv->payment_status . '</strong> & ' . lang('paid_amount') . ' <strong>' . $this->erp->formatMoney($inv->paid) . '</strong></p><p>'.lang('adjust_payments').'</p></div>';
                            } else {
                                echo '<div class="alert alert-warning"><p>' . lang('payment_status') . ': <strong>' . $inv->payment_status . '</strong> & ' . lang('paid_amount') . ' <strong>' . $this->erp->formatMoney($inv->paid) . '</strong></p><p>'.lang('adjust_payments').'</p></div>';
                            }
                            ?>

						...
						<div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <?php 
									...
									echo form_dropdown('payment_term', $pt, $purchase->payment_term, 'id="slpayment_term" class="form-control input-tip select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("payment_term") . '" style="width:100%;" ');
								?>
							</div>
                        </div>

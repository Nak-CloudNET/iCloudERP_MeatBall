...
<div class="modal-dialog">
    <div class="modal-content">
		...
		<?php foreach ($combine_purchases->result() as $combine_purchase) { 
			if($combine_purchase->balance==0 && $combine_purchase->payment_status=="paid"){
                    ...
                    <?php if (!empty($combine_purchases)) {
                        ...
                        foreach ($combine_purchases->result() as $combine_purchase) { ?>
                            <tr class="row<?= $combine_purchase->id ?>">
								...
								<td class="balance"><?= $combine_purchase->balance; ?></td>
                                <td class="col-xs-3">

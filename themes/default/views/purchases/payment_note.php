        ...
        <div class="modal-body print">
            ...
            <?php if ($logo) { ?>
                ...
                <img src="<?= base_url('assets/uploads/logos/' . $Settings->logo2) ?>"
                     alt="<?= $Settings->site_name ?>"><div style="margin-top: -21px; margin-left: 247px; font-weight: bold;"><i><?=lang('payment_voucher') ?></i></div>
                <!--</div>-->
            <?php } ?>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <p style="font-weight:bold;"><?= lang("date"); ?>: <?= $this->erp->hrld($payment->date); ?></p>

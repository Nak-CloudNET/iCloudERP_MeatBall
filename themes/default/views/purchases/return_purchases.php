<script>
    $(document).ready(function () {
        var oTable = $('#RESLData').dataTable({
            ...
            "aoColumns": [{"mRender": fld}, null, null, null, {"mRender": formatPurDecimal}, {"mRender": formatPurDecimal}, {"bVisible": false, "bSortable": false}],
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                ...
                nCells[4].innerHTML = formatPurDecimal(parseFloat(sc));
                nCells[5].innerHTML = formatPurDecimal(parseFloat(gtotal));
            }
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-barcode"></i><?= lang('list_purchase_return'); ?></h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?= site_url('purchases/add_purchase_return') ?>"><i class="fa fa-plus-circle"></i> <?= lang('add_purchase_return') ?></a></li>
						<?php if ($Owner || $Admin) { ?>
							<li>
...
<script>
	$(document).ready(function(){
		$("#excel").click(function(e){
			e.preventDefault();
			window.location.href = "<?=site_url('Purchases/return_purchase_actions/0/xls/')?>";
			return false;
		});
		$('#pdf').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('Purchases/return_purchase_actions/pdf/?v=1'.$v)?>";
            return false;
        });
	});
</script>
    ...
    $(document).ready(function () {
        ...
        $(document).ready(function () {
            ...
            var oTable = $('#DepData').dataTable({
                ...
                'sAjaxSource': '<?= site_url('suppliers/getDeposits/') ?>',
                ...
                "aoColumns": [{
					"bSortable": false,
					"mRender": checkbox
				},{"mRender": fld}, null, {"mRender": null}, null, null, {"bSortable": false}],
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i><?= lang('supplier_deposit'); ?></h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= site_url('suppliers/add_deposit'); ?>" data-toggle="modal" data-target="#myModal" id="add">

...
<script>
    $(document).ready(function () {
        var oTable = $('#POData').dataTable({
            ...
            'sAjaxSource': '<?=site_url('taxes/getPurchases' . ($warehouse_id ? '/' . $warehouse_id : '')).'/?v=1'.$v?>',
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, {"mRender": fld}, null, null, null, {"mRender": row_status}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat},null, {"mRender": row_status_confirm}],
            ...
            {column_number: 9, filter_default_label: "[<?=lang('remark');?>]", filter_type: "text", data: []},
        ], "footer");
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
						...
						<li>
                            <a href="javascript:void(0)" id="purchase_tax" data-action="purchase_tax">
                                <i class="fa fa-file-text-o"></i> <?=lang('add_purchasing_tax')?>
                            </a>
                        </li>
						-->
                        <li>

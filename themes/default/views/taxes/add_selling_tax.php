                    ...
                    <?php if (!empty($combine_tax)) {
                        foreach ($combine_tax->result() as $combine_taxes) { ?>
                            <tr class="row<?= $combine_taxes->id ?>">
								...
								<td>
                                    <input type="text" name="amount_declare[]" class="amount_declare form-control" style="width:150px" value="
									<?php
										$amount_declare=$amount-$vat;
										echo $amount_declare;
									?>
									">
								</td>
								...
								<?php
									$total_amount_declare=$amount_declare+$vat_declare;

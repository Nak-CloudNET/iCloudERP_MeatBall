        ...
        <header id="header" class="navbar">
            <div class="container">
                ...
                <div class="header-nav">
                    ...
                    <ul class="nav navbar-nav pull-right">
					<!--	<li id="screen" class="dropdown hidden-xs"><a class="btn tip" title="<?= lang('screen') ?>" data-placement="left" href="<?= site_url('welcome/screen') ?>"><i class="fa fa-desktop"></i><p><?= lang('screen') ?></p></a>
						</li> -->
                                                            ...
                                                            <?php if (($Owner || $Admin) || ($qty_alert_num > 0 || $exp_alert_num > 0 || !empty($payment_customer_alert_num) || !empty($payment_purchase_alert_num) || !empty($delivery_alert_num))) { ?>
                                                                <script type="text/javascript">
																	$(function(){
																		<?php 
																				$alert_num = 0;
																				foreach($invoice_alert_num as $invoice_alert){
																					$alert_num += $invoice_alert->alert_num;
																				}
																		?>
																		$alerts = 0;	
																		$alerts += Number("<?= $qty_alert_num; ?>");
																		$alerts += Number("<?= $alert_num; ?>");
																		$(".alert_msg").text($alerts);
																	});
																</script>
																<li class="dropdown hidden-sm">
                                                                    <a class="btn blightOrange tip" title="<?= lang('alerts') ?>" data-placement="left" data-toggle="dropdown" href="#">
                                                                        <i class="fa fa-exclamation-triangle"></i><p><?= lang('alerts') ?><span class="label label-danger alert_msg"></span></p>
                                                                    </a>
                                                                    <ul class="dropdown-menu pull-right">
                                                                        <li>
                                                                    ...
                                                                    <!--    <li>
                                                                        ...
                                                                        <li>
																			...
																			<a href="<?= site_url('pos/sales/?d='. date('Y-m-d', strtotime($payment_customer_alert_num->date))) ?>" class="">
																		...
																		<li>
                                                                            <?php foreach($day_customer_alert_num as $day_customer_alert) {} ?>
																			<a href="<?= site_url('reports/customers/?d='.'due') ?>" class="">
																				<span class="label label-danger pull-right" style="margin-top:3px;"><?= $day_customer_alert_num->alert_num; ?></span>
																				<span style="padding-right: 35px;"><?= lang('day_payment_term_alerts') ?></span>
																			</a>
                                                                        </li> --> 
																		<li>
                                                                            <?php 
																				...
																				foreach($invoice_alert_num as $invoice_alert){
																					$alert_num += $invoice_alert->alert_num;
																					$cus_id[] = $invoice_alert->customer_id;
																				}
																				$cus_id = implode('_', $cus_id);
																			?>
																			<a href="<?= site_url('reports/customers/?term_invoice='.$cus_id) ?>" class="">
																				<span class="label label-danger pull-right" style="margin-top:3px;"><?= $alert_num; ?></span>
																				<span style="padding-right: 35px;"><?= lang('invoice_payment_term_alerts') ?></span>
																			</a>
                                                                        </li>
                                                                    <!--    <li>
                                                                    ...
                                                                    <!--    <li>
																		...
																		<!-- Quatation Alert -->
																		<!--<li>
                                                                            <a href="<?= site_url('quotes/quatation_alert/') ?>" class="">
                                                                                <span class="label label-danger pull-right" style="margin-top:3px;"><?= $quatation_alert_num; ?></span>
                                                                                <span style="padding-right: 35px;"><?= lang('quatation_alerts') ?></span>
                                                                            </a>
                                                                        </li>-->
                            ...
                            ?>
                                    ...
                                    <ul><?php if (POS) { ?>
                                            <li id="pos_sales">
                                                <a class="submenu" href="<?= site_url('pos/sales'); ?>">
                                                    <i class="fa fa-heart"></i>
                                                    <span class="text"> <?= lang('list_sale_pos'); ?></span>
                                                </a>
                                            </li>
                                            <?php } ?>
                                    <!--    <li id="sales_index">
                                    ...
                                    <ul>
										...
										<li id="account_deposits">
                                            <a class="submenu" href="<?= site_url('account/deposits'); ?>">
                                                <i class="fa fa-list"></i><span class="text"> <?= lang('customer_deposit_list'); ?></span>
                                            </a>
                                        </li>
										<li id="account_deposits">
                                            <a class="submenu" href="<?= site_url('suppliers/deposits'); ?>">
                                                <i class="fa fa-plus-circle"></i><span class="text"> <?= lang('supplier_deposit_list'); ?></span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="mm_taxes">
                                    ...
                                    <ul>
										...
										<li id="taxes_selling_tax_manual">
											<a class="submenu" href="<?= site_url('taxes/selling_tax_manual'); ?>" data-toggle="modal" data-target="#myModal">
												<i class="fa fa-plus-circle"></i><span class="text"> <?= lang('selling_tax_manual'); ?></span>
											</a>
										</li>
										...
										<li id="taxes_purchasing_tax_manual">
											<a class="submenu" href="<?= site_url('taxes/purchasing_tax_manual'); ?>" data-toggle="modal" data-target="#myModal">
												<i class="fa fa-plus-circle"></i><span class="text"> <?= lang('purchasing_tax_manual'); ?></span>
											</a>
										</li>
										...
										<li id="taxes_tax_return_for_small_tax_payers">
                                            <a class="submenu" href="<?= site_url('taxes/tax_return_for_small_tax_payers'); ?>" >
                                                <i class="fa fa-plus-circle"></i><span class="text"> <?= lang('tax_return_for_small_tax_payers'); ?></span>
                                            </a>
                                        </li>
                                    	<li id="taxes_prepayment_profit_tax">
                                            <a class="submenu" href="<?= site_url('taxes/prepayment_profit_tax'); ?>" >
                                                <i class="fa fa-plus-circle"></i><span class="text"> <?= lang('prepayment_profit_tax'); ?></span>
                                            </a>
                                        </li>
                                        <li id="taxes_condition_tax">
                                            <a class="submenu" href="<?= site_url('account/condition_tax'); ?>">
                                    	...
                                    	<li id="taxes_index">
                                            <a class="submenu" href="<?= site_url('taxes'); ?>" >
                                ...
                                <?php if ($Owner) { ?>
                                    <li class="mm_system_settings <?= strtolower($this->router->fetch_method()) != 'settings' ? '' : 'mm_pos' ?>">
                                        ...
                                        <ul>
                                            ...
                                            <?php if (POS) { ?>
												...
												<!--	<li id="system_settings_customer_products">
														<a href="<?= site_url('system_settings/customer_products') ?>">
															<i class="fa fa-dollar"></i><span class="text"> <?= lang('customer_products'); ?></span>
														</a>
													</li> -->
                                    ...
                                    <?php } ?>
														...
														<li id="reports_products">
															...
															<li id="reports_stock">
                                                                    <a href="<?= site_url('reports/stock') ?>">
                                                                        <i class="fa fa-calendar-o"></i><span class="text"> <?= lang('daily_stock'); ?></span>
                                                                    </a>
                                                            </li>
													</ul>
												</li>
													...
													<ul>
														<li id="reports_daily_sales">
															...
															-->
																...
																<li id="reports_suspend_profit_loss">
                                                                    <a href="<?= site_url('reports/suspend_profit_loss') ?>">
                                                                        <i class="fa fa-users"></i><span class="text"> <?= lang('suspend_profit_loss'); ?></span>
                                                                    </a>
                                                                </li>-->
										...
										<li class="mm_taxes_reports">
                                            ...
                                            <ul>
                                                <li id="taxes_reports_value_added_tax">
                                                    <a href="<?= site_url('taxes_reports/value_added_tax') ?>">
                                                        <i class="fa fa-building"></i><span class="text"> <?= lang('value_added_tax'); ?></span>
                                                    </a>
                                                </li>
                                                <li id="taxes_reports_tax_salary_list">
                                                    <a href="<?= site_url('taxes_reports/tax_salary_list') ?>">
                                                        <i class="fa fa-bars"></i><span class="text"> <?= lang('tax_salary_list'); ?></span>
                                                    </a>
                                                </li>
                                             	<li id="taxes_reports_prepayment_profit_tax_list">
                                                    <a href="<?= site_url('taxes_reports/prepayment_profit_tax_list') ?>">
                                                        <i class="fa fa-bars"></i><span class="text"> <?= lang('prepayment_profit_tax_list'); ?></span>
                                                    </a>
                                                </li>

						<li id="taxes_reports_withholding_tax">
                                                    <a href="<?= site_url('taxes_reports/withholding_tax') ?>">
                                                        <i class="fa fa-building"></i><span class="text"> <?= lang('withholding_tax'); ?></span>
                                                    </a>
                                                </li>
<li id="taxes_reports_sales_journal_list">
...
<li id="taxes_reports_purchase_journal_list">
                                             	...
                                             	<li id="govreports_trial_balance_tax">
                                                    <a href="<?= site_url('#') ?>">
                                                        <i class="fa fa-building"></i><span class="text"> <?= lang('trial_balance_tax'); ?></span>
                                                    </a>
                                                </li>
<li id="govreports_balance_sheet_tax">
                                                ...
                                                <li id="govreports_annual_profit_tax">
                                                    <a href="<?= site_url('#') ?>">
                                                        <i class="fa fa-building"></i><span class="text"> <?= lang('annual_profit_tax'); ?></span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
                            ...
                            ?>
                        <?php if ($GP['products-index'] || $GP['products-add']) { ?>
                            <li class="mm_products">
                                <a class="dropmenu" href="#">
                                    <i class="fa fa-barcode"></i>
                        ...
                        <?php if ($GP['sales-index']) { ?>
                            <li class="mm_sales <?= strtolower($this->router->fetch_method()) == 'settings' ? '' : 'mm_pos' ?>">
                                <a class="dropmenu" href="#">
                                    <i class="fa fa-heart"></i>
									<span class="text"> <?= lang('manage_sales'); ?> </span> 
									<span class="chevron closed"></span>
                                </a>
								<ul>
								<!--	<li id="sales_index">
						...
						<?php if ($GP['purchases-index']) { ?>
							...
							<?php if ($GP['transfers-index']) { ?>
								...
								<!--<li class="mm_account">
                                    ...
                                    <ul>
                                        ...
                                        <li id="account_list_ac_recevable">
                                            <a class="submenu" href="<?= site_url('account/list_ac_recevable'); ?>">
                                                <i class="fa fa-list"></i><span class="text"> <?= lang('List A/C Receivable'); ?></span>
                                            </a>
                                        </li>
										<?php if ($GP['accounts-add']) { ?>
                                        <li id="account_billReceipt">
                                        ...
                                        <li id="account_list_ac_payable">
                                            <a class="submenu" href="<?= site_url('account/list_ac_payable'); ?>">
                                                <i class="fa fa-list"></i><span class="text"> <?= 'List A/C Payable'; ?></span>
                                            </a>
                                        </li>
										<?php if ($GP['accounts-add']) { ?>
                                        <li id="account_billPayable">
							...
							<?php if ($GP['reports-products'] || $GP['reports-sales'] || $GP['reports-profit']) { ?>
								<li class="mm_reports mm_profit_report">
									<a class="dropmenu" href="#">
										<i class="fa fa-bar-chart-o"></i>
										<span class="text"> <?= lang('reports'); ?> </span>
										<span class="chevron closed"></span>

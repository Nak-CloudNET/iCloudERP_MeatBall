...
<script type="text/javascript">
	...
	$(window).load(function(){
      $('#slpayment_status').select2("readonly", true);
      $('#slsale_status').select2("readonly", true);
	});
</script>
                    ...
                    <!--    <div class="col-md-4">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                echo form_dropdown('sale_status', $sst, '', 'class="form-control input-tip" required="required" input-tip id="slsale_status"');
                                ?>
                            </div>
                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <?= form_input('payment_reference_no', isset($payment->reference_no)?$payment->reference_no:'', 'class="form-control tip" id="payment_reference_no" readonly = "readonly" '); ?>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="payment">
                                                    <div class="form-group ngc">
                                                        ...
                                                        <input name="amount-paid" type="text" id="amount_1" readonly class="pa form-control kb-pad amount" value="<?php echo isset($payment->amount)? $payment->amount:'' ?>"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

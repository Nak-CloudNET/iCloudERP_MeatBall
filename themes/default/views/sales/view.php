    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="col-xs-4">
                    <div class="col-xs-3"><i class="fa fa-3x fa-file-text-o padding010 text-muted"></i></div>
                    <div class="col-xs-16">
                    ...
                    <table class="table table-bordered table-hover table-striped print-table order-table">
						...
						if($pos->show_product_code == 0) {
                            ...
                            <tr>
                                ...
                                ?>
                                <td style="text-align:right; width:120px; padding-right:10px;"><?= $row->subtotal!=0?$this->erp->formatMoney($row->real_unit_price):$free; ?></td>
                                <?php
                                if ($Settings->tax1) {

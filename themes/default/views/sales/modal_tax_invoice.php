	...
	<table class="table-responsive" width="1024px" border="0" cellspacing="0" style="margin:auto;">
		<tr>
			...
			<td colspan="3" width="65%" style="padding-left:50px;">
				<div style="font-family:'Khmer OS Muol Light'; font-size:20px;"><?= $biller->cf1 != '-' ? $biller->cf1 : $biller->cf2; ?></div>
				<div style="font-family:'Arial'; font-size:20px;"><?= $biller->company != '-' ? $biller->company : $biller->name; ?></div>
			</td>
		</tr>
		<tr>
			<td colspan="2"> </td>

...
<body>
	<?php
		...
		$rows = $this->pos_model->getAllInvoiceItems($id);
        ...
        $payments = $this->pos_model->getInvoicePaymentsPOS($id);
	?>	
	<div class="wraper">  
		<div class="container-fluid pdT50">
			<div class="row-content">
				   <div class="col-md-12 padding0">
				   <div class="col-md-6 col-sm-6 col-xs-6" style="margin-top:-30px !important;">
						...
						<div class="invoice">
							<div class="pull-right">
							   <table  width="100%">
								  ...
								  <tr class="bg">
									  <th colspan="2" height="35px;" style="text-align:left;border:solid 1px">អតិថិជន : <?=$customer->name?></th>
						...
						<tbody>	
							...
							?>
							  ...
							  <tr height="30px">
									...
									<td align="center"><?= $this->erp->formatQty($row->quantity); ?><?php echo ' '.$product_unit?></td>
		...
		<div class="col-md-12" style="margin:50px 0px;">
			<button type="button" class="btn btn-primary btn-default     pull-left" onclick="window.print();">
				<i class="fa fa-print"></i> <?= lang('print'); ?>
					...
					<a href="<?= site_url('pos/sales'); ?>"><button class="btn btn-warning " ><i class="fa fa-heart"></i>&nbsp;<?= lang("back_to_pos_sale"); ?></button></a>
					<a href="<?= site_url('pos'); ?>"><button class="btn btn-warning " ><i class="fa fa-heart"></i>&nbsp;<?= lang("back_to_pos"); ?></button></a>
		</div>
	</div>
</body>
</html>

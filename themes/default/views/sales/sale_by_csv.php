                        ...
                        <div class="col-md-12">
                            ...
                            <div class="well well-sm">
                                ...
                                <?php echo $this->lang->line("csv2"); ?> <span
                                    class="text-info">( <?= lang("product_code") . ', ' . lang("net_unit_price") . ', ' . lang("quantity") . ', ' . lang("customer_no") . ', ' . lang("reference_no") . ', ' . lang("date") . ', ' . lang("shop_id") . ', ' . lang("sale_status") . ', ' . lang("payment_term") . ', ' . lang("payment_status") . ', ' . lang("shipping") . ', ' . lang("order_discount") . ', ' . lang("order_tax"); ?> )</span> <?php echo $this->lang->line("csv3"); ?><br>

...
<script>
    $(document).ready(function () {
        ...
        var oTable = $('#SupData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('sales/getSuspends_calendar').'/?v=1'.$v ?>',
            ...
            "aoColumns": [{
                ...
                "mRender": attachment,
                "mRender": checkbox
            }, null, null, null, {"mRender": currencyFormat}, {"mRender": currencyFormat}, null, null, null, null, {"mRender": row_suspend}, {"mRender": attachment}],
			'fnRowCallback': function (nRow, aData, iDisplayIndex) {
				...
				*/
				if(aData[10] == 'free'){
					...
					$('td:eq(10)', nRow).addClass( 'pos' );
					$('td:eq(10)', nRow).attr("id", aData[2]);
					nRow.className = "book_link";
				}else if(aData[10] == 'book'){
					nRow.id = aData[0];
					nRow.className = "pos_list";
				}else{
					nRow.id = aData[0];
            ...
            {column_number: 2, filter_default_label: "[<?=lang('suspend_name');?>]", filter_type: "text", data: []},
            ...
            {column_number: 5, filter_default_label: "[<?=lang('deposite');?>]", filter_type: "text", data: []},
			...
			{column_number: 8, filter_default_label: "[<?=lang('end_date');?>]", filter_type: "text", data: []},
            {column_number: 9, filter_default_label: "[<?=lang('term_of_rent_months');?>]", filter_type: "text", data: []},
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
						...
						<?php if ($Owner || $Admin) { ?>
							<li>
								...
								<i class="fa fa-plus-circle"></i> <?= lang("add_suppend_csv"); ?> </a>
							</li>
							<li>
        ...
        <div class="row">
            <div class="col-lg-12">
				...
				<div id="form">
                    ...
                    <?php echo form_open("sales/suspends_calendar"); ?>
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label class="control-label" for="reference_no"><?= lang("suspend"); ?></label>

        ...
        <div class="col-lg-12">
            ...
            <div class="row padding10">
                <div class="col-xs-4" style="float: left;font-size:14px">
					<h5 style="float:left"><?= lang("from"); ?> :&nbsp;&nbsp;</h5>
					<div>
                ...
                <div class="col-xs-4"  style="float: right;font-size:14px">
					<h5 style="float:left"><?= lang("to_");?> :&nbsp;&nbsp;</h5>
					<div>
            ...
            <div class="row">
                ...
                <div class="col-md-2  pull-left" style="text-align:center">
					<hr/>
                    <p><?= lang("Customer's Signature"); ?></p>
                </div>
				<div class="col-md-2 " style="text-align:center">
                    <hr/>
					<p><?= lang("Authorized Signature"); ?></p>
                </div>
            </div>
        </div>
		<div class="col-md-12">
			<strong>
				<?php echo $biller->invoice_footer;?><br>
				ACLEDA Bank Plc... A/C Name: Oeng Chhaily,A/C No:2900-20-290297-1-8 (USD)<br>
				ACLEDA Bank Plc... A/C Name: Oeng Chhaily,A/C No:2800-20-290297-1-4 (Reil)<br>
			</strong>
		</div>
    </div>
</div>
...
<div class="col-md-12" style="margin-bottom:20px;">
	...
	<a href="<?=base_url()?>sales/print_lvs/<?=$sid?>" target="_blank"><button class="btn btn-primary no-print" ><i class="fa fa-print"></i>&nbsp;<?= lang("LVS Invoice"); ?></button></a>&nbsp;&nbsp;

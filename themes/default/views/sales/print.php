                    ...
                    <tbody style="font-size: 13px;">
						...
						if($pos->show_product_code == 0) {
							...
							<tr>
								...
								?>
								<td style="text-align:center; width:15%;vertical-align:middle;"><?= $row->subtotal!=0?$this->erp->formatMoney($row->real_unit_price):$free; ?></td>
								<?php
								if ($Settings->tax1) {
...
<div class="col-xs-12" style="margin-bottom:20px;">
	...
	<a href="<?=base_url()?>sales/print_pp/<?=$sid?>" target="_blank"><button class="btn btn-primary no-print" ><i class="fa fa-print"></i>&nbsp;<?= lang("PP Invoice"); ?></button></a>&nbsp;&nbsp;

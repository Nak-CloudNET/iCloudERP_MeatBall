                ...
                <table class="table table-bordered table-hover table-striped print-table order-table">
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="width: 80px; text-align:center; vertical-align:middle;"><?= $this->erp->formatQuantity($row->quantity).' '.$row->unit; ?></td>
                            <!-- <td style="text-align:right; width:100px;"><?= $this->erp->formatMoney($row->net_unit_price).' ៛'; ?></td> -->
							<td style="text-align:right; width:100px;"><?= $row->subtotal!=0?$this->erp->formatMoney($row->real_unit_price).' ៛':$free.' ៛'; ?></td>
                            <?php
                            if ($Settings->tax1) {

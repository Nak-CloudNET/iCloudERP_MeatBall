        ...
        <div class="modal-body">
            <div class="table-responsive">
                <table class="table table-striped table-bordered" style="margin-bottom:0;">
					...
					<tr>
                        <td><strong><?= lang("price_groups"); ?></strong></td>
                        <td><?= $customer->price_group_name; ?></strong></td>
                    </tr>
                    <tr>
                ...
                <!--    <tr>
					...
					<tr>
                        <td><strong><?= lang("invoice_payment_term"); ?></strong></td>
                        <td><?= $customer->invoice_payment_term; ?></strong></td>
                    </tr>
                    <!-- <tr>

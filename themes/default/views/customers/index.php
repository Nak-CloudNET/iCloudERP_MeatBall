    ...
    $(document).ready(function () {
        ...
        var cTable = $('#CusData').dataTable({
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, {"mRender": center}, null, null, null, null, null, null,{"mRender": currencyFormat}, {"bSortable": false}]
        }).dtFilter([
            ...
            {column_number: 4, filter_default_label: "[<?=lang('price_groups');?>]", filter_type: "text", data: []},
            ...
            {column_number: 8, filter_default_label: "[<?=lang('invoice_payment_term');?>]", filter_type: "text", data: []},
        ], "footer");
                ...
                <div class="table-responsive">
                    <table id="CusData" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr class="primary">
                            ...
                            <th><?= lang("company"); ?></th>
                            <th><?= lang("name"); ?></th>
                            <th><?= lang("price_groups"); ?></th>
                            <th><?= lang("customer_group"); ?></th>
                            <th><?= lang("address"); ?></th>
                            <th><?= lang("phone"); ?></th>
                            <th><?= lang("invoice_payment_term"); ?></th>

							...
							<table cellpadding="0" cellspacing="0" border="0"
								...
								<tbody id="show_data">
									...
									<tr>
										...
										<td>
                                            <?= $this->erp->formatMoney($anlysis->Ccost / $anlysis->Cquantity);?>
                                        </td>
										<td><?= $this->erp->formatMoney($percentage); ?>%</td>
									</tr>
									<?php
										}
									?>
								...
								<tfoot>
									<tr>
										...
										<th><?= $this->erp->formatMoney($total_cost);?></th>
										<th><?= $total_percent; ?>%</th>
									</tr>
								</tfoot>
							</table>
							...
							<table cellpadding="0" cellspacing="0" border="0"
								...
								<tbody id="show_data">
									<?php
										...
										foreach($add as $total){
											...
											$addCost += $total->Ccost / $total->Cquantity;
											$add_cost = $total->Ccost;
										}
								...
								<tfoot>
									<tr>
										...
										<th><?= $this->erp->formatMoney($addCost); ?></th>
										<th><?= $add_percent; ?>%</th>
									</tr>
								</tfoot>
							</table>

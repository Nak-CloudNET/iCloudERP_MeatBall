...
class Documents extends MY_Controller
{
	...
	function getDocuments()
	{
		...
		->add_column("Actions", "<center><a class=\"tip\" title='" . $this->lang->line("add_quotation") . "' href='" . site_url('quotes/add/$1') . "'><i class=\"fa fa-save\"></i></a>  <a class=\"tip\" title='" . $this->lang->line("edit_catalog") . "' href='" . site_url('documents/edit/$1') . "' data-toggle='modal' data-target='#myModal'><i class=\"fa fa-edit\"></i></a>  <a href='#' class='tip po' title='<b>" . $this->lang->line("delete_catalog") . "</b>' data-content=\"<p>" . lang('r_u_sure') . "</p><a class='btn btn-danger po-delete' href='" . site_url('documents/delete/$1') . "'>" . lang('i_m_sure') . "</a> <button class='btn po-close'>" . lang('no') . "</button>\"  rel='popover'><i class=\"fa fa-trash-o\"></i></a></center>", "documents.id");

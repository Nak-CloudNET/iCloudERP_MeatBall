...
class Suppliers extends MY_Controller
{
    ...
    function getSuppliers()
    {
        ...
        $this->datatables
            ->select("id,id as sup_no, company, name, email, phone, city, country, vat_no")
            ->from("companies")
	...
	public function getDeposits(){
    	...
    	<ul class="dropdown-menu pull-right" role="menu">
    		...
    		$this->load->library('datatables');
    		$this->datatables
    		->select("deposits.id as dep_id, companies.id AS id , deposits.date,companies.name, deposits.amount, deposits.paid_by, CONCAT({$this->db->dbprefix('users')}.first_name, ' ', {$this->db->dbprefix('users')}.last_name) as created_by", false)
    		->from("deposits")
	...
	function add_deposit()
    {
        ...
        if ($this->form_validation->run() == true && $this->companies_model->addSupplierDeposit($data, $cdata, $payment)) {
